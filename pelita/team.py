...
from .network import (PELITA_PORT, RemotePlayerFailure, RemotePlayerConnection,
                      RemotePlayerRecvTimeout, RemotePlayerSendError)
...
class SubprocessTeam:
    ...
    def _exit(self, game_state=None):
        ...
        try:
            ...
            self.zmqconnection.send_req("exit", payload, timeout=1)
...
class RemoteTeam:
    ...
    def wait_ready(self):
        msg = self.zmqconnection.recv_status(10)
        # print(msg)
