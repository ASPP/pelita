...
* Follow your instinct, follow the style of the surrounding lines.
...
We use the `Sphinx Python Documentation Generator <http://www.sphinx-doc.org/>`_
to generate the project website and `GitHub pages <https://pages.github.com/>`_ to host it.
