...
To have them available in the Pelita namespace we make them available from the
autogenerated module ``pelita.__layouts`` module. When converting from filenames
...
Once you ahve found a layout you like, pass the desired layout name to the
...
from a given file.  Assumuming you have a file ``my_layout.layout`` you would
use:
