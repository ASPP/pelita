...
Using ``layout_name`` and  you can use any of the mazes provided. 
You can get a list of the available layouts using : 
...
You can even filter the results. If, for example, you want to see
layouts without dead ends: ::

    >>> get_available_layouts(filter='without_dead_ends')
    ... ['layout_01_without_dead_ends', 'layout_02_without_dead_ends',
    ...  'layout_03_without_dead_ends', 'layout_04_without_dead_ends',
    ... ...]

You can get a specific layout by name using: ``pelita.layout.get_layout_by_name``::
...
You can get a random layout with ``pelita.layout.get_random_layout``::

    >>> print get_random_layout()
    ##################################
    #...       .   #  #.#   . #. #  3#
    ###### ## ####  . #.# .## ## # #1#
    #.#.   #       #..# #  #  #  #   #
...
You can use a filter also in this case ::

    >>> print get_random_layout(filter='without_dead_ends')
    ##################################
    #    #.   . . .# .#             3#
    #  #  .#  .#.#.# .    .    .    1#
    ######## ###.# #    ####   # #####
