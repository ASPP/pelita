...
do
   ...
   ./create_maze.py --seed=$SEED --dead-ends --height=16 --width=32 > "normal_dead_ends_"$COUNT".layout"
done
...
do
   ...
   ./create_maze.py --seed=$SEED --dead-ends --food=10 --height=8 --width=18 > "small_dead_ends_"$COUNT".layout"
done
...
do
   ...
   ./create_maze.py --seed=$SEED --dead-ends --food=60 --height=32 --width=64 > "big_dead_ends_"$COUNT".layout"
done
